	...
	return (
		<>
			<Layout>
				...
				{/*						<Link href="/services" className="tracking-wide hover-up-2 block sm:inline-block py-4 px-8 mb-4 sm:mb-0 sm:mr-3 text-xs text-white text-center font-semibold leading-none bg-blue-400 hover:bg-blue-500 rounded wow animate__animatedanimated animate__fadeIn">Our Services*/}
				{/*						</Link>*/}
				{/*						<Link href="#how-we-work" className="block hover-up-2 sm:inline-block py-4 px-8 text-xs text-blueGray-500 hover:text-blueGray-600 text-center font-semibold leading-none bg-white border border-blueGray-200 hover:border-blueGray-300 rounded wow animate__animatedanimated animate__fadeIn" data-wow-delay=".3s">*/}
				{/*							How We Work?*/}
						...
						<div className="flex flex-wrap items-center justify-between max-w-2xl lg:max-w-full mb-12">
							<div className="w-full lg:w-1/2 mb-4 lg:mb-0">
								<h2 className="text-3xl md:text-4xl font-bold font-heading wow animate__animatedanimated animate__fadeInDown">
									...
									<span className="text-blue-500"> помочь вам</span>
									<br />
									<span>достичь желаемого</span>
								</h2>
							</div>
							<div className="w-full lg:w-1/2">
								<p className="text-blueGray-400 leading-loose wow animate__animatedanimated animate__fadeIn"> "Несправедливость, совершенная в отношении одного, является угрозой для всех."
									— Шарль Луи де Монтескье </p>
							</div>
						</div>
						<div className="flex flex-wrap -mx-3 -mb-6 text-center">
							<div className="hover-up-5 w-full md:w-1/2 lg:w-1/3 px-3 mb-6 wow animate__animated animate__fadeIn" data-wow-delay=".3s">
								<div className="p-12 bg-white shadow rounded">
									...
									<h3 className="mb-2 font-bold font-heading text-xl">Определение Проблемы</h3>
									<p className="text-sm text-blueGray-400 leading-relaxed">Онлайн-опрос или форма для уточнения запроса.
										Юридический чат-бот для первичной консультации.</p>
								</div>
							</div>
							<div className="hover-up-5 w-full md:w-1/2 lg:w-1/3 px-3 mb-6 wow animate__animated animate__fadeIn" data-wow-delay=".5s">
								<div className="p-12 bg-white shadow rounded">
									...
									<h3 className="mb-2 font-bold font-heading text-xl">Выбор Специалиста или Услуги</h3>
									<p className="text-sm text-blueGray-400 leading-relaxed">Список юристов с рейтингами и отзывами.
										Каталог стандартных юридических услуг.</p>
								</div>
							</div>
							<div className="hover-up-5 w-full lg:w-1/3 px-3 mb-6">
								<div className="p-12 bg-white shadow rounded wow animate__animated animate__fadeIn" data-wow-delay=".7s">
									...
									<h3 className="mb-2 font-bold font-heading text-xl">Окозание качественной услуги</h3>
									<p className="text-sm text-blueGray-400 leading-relaxed">Онлайн-консультация (чат, аудио, видео).
				...
				<section className="py-20">
					<div className="container text-center">
						<div className="max-w-lg mx-auto mb-16">
							<span className="inline-block py-1 px-3 text-xs font-semibold bg-blue-100 text-blue-600 rounded-xl"> О наших экспертах</span>
							<h2 className="text-3xl md:text-4xl mt-2 mb-4 font-bold font-heading">
								Доверьтесь нашим <span className="text-blue-500"> специалистам </span>
							</h2>
							<p className="text-blueGray-400 leading-loose">Наши ИТ-услуги объединяют экспертов и технологии, чтобы помочь именно вам</p>
						</div>
							...
							<div className="w-1/2 lg:w-1/4 px-5 mb-12">
								<div className="hover-up-5 pt-8 pb-8 px-4 text-center bg-white rounded shadow wow animate__animated animate__fadeIn animated border border-gray-100 hover:border-gray-200" data-wow-delay=".1s">
									<Image
										...
										height="0"
										sizes="100vw"
										style={{ width: "auto", height: "auto" }} className="mb-6 h-24 w-24 mx-auto rounded-full object-cover object-top" src="/assets/imgs/placeholders/avatar-1.png" alt="Monst" />
							...
							<div className="w-1/2 lg:w-1/4 px-5 mb-12">
								<div className="hover-up-5 pt-8 pb-8 px-4 text-center bg-white rounded shadow wow animate__animated animate__fadeIn animated border border-gray-100 hover:border-gray-200" data-wow-delay=".3s">
									<Image
										...
										height="0"
										sizes="100vw"
										style={{ width: "auto", height: "auto" }} className="mb-6 h-24 w-24 mx-auto rounded-full object-cover object-top" src="/assets/imgs/placeholders/avatar-2.png" alt="Monst" />
							...
							<div className="w-1/2 lg:w-1/4 px-5 mb-12">
								<div className="hover-up-5 pt-8 pb-8 px-4 text-center bg-white rounded shadow wow animate__animated animate__fadeIn animated border border-gray-100 hover:border-gray-200" data-wow-delay=".5s">
									<Image
										...
										height="0"
										sizes="100vw"
										style={{ width: "auto", height: "auto" }} className="mb-6 h-24 w-24 mx-auto rounded-full object-cover object-top" src="/assets/imgs/placeholders/avatar-3.png" alt="Monst" />
							...
							<div className="w-1/2 lg:w-1/4 px-5 mb-12">
								<div className="hover-up-5 pt-8 pb-8 px-4 text-center bg-white rounded shadow wow animate__animated animate__fadeIn animated border border-gray-100 hover:border-gray-200" data-wow-delay=".7s">
									<Image
										...
										height="0"
										sizes="100vw"
										style={{ width: "auto", height: "auto" }} className="mb-6 h-24 w-24 mx-auto rounded-full object-cover object-top" src="/assets/imgs/placeholders/avatar-4.png" alt="Monst" />
							...
							<div className="w-1/2 lg:w-1/4 px-5">
								<div className="hover-up-5 pt-8 pb-8 px-4 text-center bg-white rounded shadow wow animate__animated animate__fadeIn animated border border-gray-100 hover:border-gray-200" data-wow-delay=".1s">
									<Image
										...
										height="0"
										sizes="100vw"
										style={{ width: "auto", height: "auto" }} className="mb-6 h-24 w-24 mx-auto rounded-full object-cover object-top" src="/assets/imgs/placeholders/avatar-5.png" alt="Monst" />
							...
							<div className="w-1/2 lg:w-1/4 px-5">
								<div className="hover-up-5 pt-8 pb-8 px-4 text-center bg-white rounded shadow wow animate__animated animate__fadeIn animated border border-gray-100 hover:border-gray-200" data-wow-delay=".3s">
									<Image
										...
										height="0"
										sizes="100vw"
										style={{ width: "auto", height: "auto" }} className="mb-6 h-24 w-24 mx-auto rounded-full object-cover object-top" src="/assets/imgs/placeholders/avatar-6.png" alt="Monst" />
							...
							<div className="w-1/2 lg:w-1/4 px-5">
								<div className="hover-up-5 pt-8 pb-8 px-4 text-center bg-white rounded shadow wow animate__animated animate__fadeIn animated border border-gray-100 hover:border-gray-200" data-wow-delay=".5s">
									<Image
										...
										height="0"
										sizes="100vw"
										style={{ width: "auto", height: "auto" }} className="mb-6 h-24 w-24 mx-auto rounded-full object-cover object-top" src="/assets/imgs/placeholders/avatar-7.png" alt="Monst" />
							...
							<div className="w-1/2 lg:w-1/4 px-5">
								<div className="hover-up-5 pt-8 pb-8 px-4 text-center bg-white rounded shadow wow animate__animated animate__fadeIn animated border border-gray-100 hover:border-gray-200" data-wow-delay=".7s">
									<Image
										...
										height="0"
										sizes="100vw"
										style={{ width: "auto", height: "auto" }} className="mb-6 h-24 w-24 mx-auto rounded-full object-cover object-top" src="/assets/imgs/placeholders/avatar-8.png" alt="Monst" />
					...
					<div className="container">
						<div className="text-center max-w-xl mx-auto">
							<h2 className="mb-4 text-3xl lg:text-3xl text-white font-bold font-heading">
								<span>Подпешитесь на нашу </span>
								<span className="text-blue-200">новостную ленту</span> <br />
								<span>и получайте самые свежие новости о нашем прогрессе.</span>
							</h2>
							<p className="mb-8 text-blueGray-200">Вся ваша информация является конфеденциальной и мы храним их бережно.</p>
