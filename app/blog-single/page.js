				...
				<section className="pb-20">
							...
							<div className="max-w-2xl mx-auto">
								<div className="text-center mb-6">
									<span className="text-base md:text-lg">
										<Link href="/blog-2" className="text-blueGray-200 hover:underline">
											<span className="inline-block py-1 px-3 text-xs font-semibold bg-blue-100 text-blue-600 rounded-xl mr-3">Bussiness</span>

										</Link>
										<span className="text-blueGray-500 text-sm">24 Jan, {new Date().getFullYear()}</span>
									</span>
								...
								<div className="flex justify-center mb-8">
									<Image
										...
										height="0"
										sizes="100vw"
										style={{ width: "auto", height: "auto" }} className="w-12 h-12 object-cover rounded-full" src="/assets/imgs/placeholders/avatar-8.png" alt="Monst" />
									<div className="pl-4">
					...
					<div className="container">
						...
						<div className="max-w-2xl mx-auto">
							...
							<Link href="#" target="_blank" className="inline-flex items-center text-gray-600 dark:text-gray-200 hover:underline mt-8">
									...
									<div className="flex">
										<div className="flex-shrink-0 mr-3">
											<Image
												...
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} className="mt-2 rounded-full w-8 h-8 sm:w-10 sm:h-10" src="/assets/imgs/placeholders/avatar-2.png" alt="Monst" />
										</div>
											...
											<div className="mt-4 flex items-center">
												<div className="flex -space-x-2 mr-2">
													<Image
														...
														height="0"
														sizes="100vw"
														style={{ width: "auto", height: "auto" }} className="rounded-full w-6 h-6 border border-white" src="/assets/imgs/placeholders/avatar-3.png" alt="Monst" />
													<Image
														width="0"
														height="0"
														sizes="100vw"
														style={{ width: "auto", height: "auto" }} className="rounded-full w-6 h-6 border border-white" src="/assets/imgs/placeholders/avatar-4.png" alt="Monst" />
												</div>
									...
									<div className="flex">
										<div className="flex-shrink-0 mr-3">
											<Image
												...
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} className="mt-2 rounded-full w-8 h-8 sm:w-10 sm:h-10" src="/assets/imgs/placeholders/avatar-5.png" alt="Monst" />
										</div>
										<div className="flex-1 border border-gray-100 rounded-lg px-4 py-2 sm:px-6 sm:py-4 leading-relaxed">
												...
												<div className="flex">
													<div className="flex-shrink-0 mr-3">
														<Image
															...
															height="0"
															sizes="100vw"
															style={{ width: "auto", height: "auto" }} className="mt-3 rounded-full w-6 h-6 sm:w-8 sm:h-8" src="/assets/imgs/placeholders/avatar-6.png" alt="Monst" />
													</div>
												...
												<div className="flex">
													<div className="flex-shrink-0 mr-3">
														<Image
															...
															height="0"
															sizes="100vw"
															style={{ width: "auto", height: "auto" }} className="mt-3 rounded-full w-6 h-6 sm:w-8 sm:h-8" src="/assets/imgs/placeholders/avatar-7.png" alt="Monst" />
													</div>
													<div className="flex-1 bg-gray-50 rounded-lg px-4 py-2 sm:px-6 sm:py-4 leading-relaxed">
														<strong>Dany </strong>
														<span className="text-xs text-gray-400">3:34 PM</span>
							...
							<div className="transition duration-300 ease-in-out transform hover:-translate-y-1 flex items-center justify-center mt-12">
								<Link href="/blog" className="px-4 py-2 mt-2 text-gray-600 transition-colors duration-200 transform border border-gray-100 rounded-lg dark:text-gray-200 dark:border-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none"> Read More Articles
								</Link>
							</div>
						</div>
					</div>
