								...
								<div className="py-12">
									<div className="max-w-lg lg:max-w-md mx-auto lg:mx-0 mb-8 text-center lg:text-left">
										<h2 className="text-3xl lg:text-5xl mb-4 font-bold font-heading wow animate__animatedanimated animate__fadeIn">
											Приверженность <span className="text-blue-500">людям</span> и будущему
										</h2>
										<div className="text-blueGray-400 leading-relaxed wow animate__animatedanimated animate__fadeIn">
											Мы <strong className="text-blue-500"> ZanNavigator</strong>, мы покажем путь{" "}
											<div className="typewrite d-inline text-brand">
												<TextEffect text1="Web Agency" text2="Social Marketing" />
											</div>
										</div>
										<p className="text-blueGray-400 leading-relaxed wow animate__animatedanimated animate__fadeIn mt-3 text-sm">Помогаем вам разобратся с помощью цифровизации</p>
									</div>
									<div className="text-center lg:text-left">
										<Link href="/about" className="tracking-wide hover-up-2 block sm:inline-block py-4 px-8 mb-4 sm:mb-0 sm:mr-3 text-xs text-white text-center font-semibold leading-none bg-blue-400 hover:bg-blue-500 rounded wow animate__animatedanimated animate__fadeIn">О нас
										</Link>
						...
						<div className="max-w-2xl mx-auto text-center">
							<div className="max-w-md mb-8 mx-auto">
								...
								<h2 className="mt-2 text-4xl font-bold font-heading wow animate__animatedanimated animate__fadeIn" data-wow-delay=".s">
									Мы будем <span className="text-blue-500">рады</span> услышать от вас!
								</h2>
							</div>
							<div>
								<form>
									<div className="mb-4 text-sm wow animate__animatedanimated animate__fadeIn" data-wow-delay=".5s">
										<span className="mr-4 font-semibold">Департамент:</span>
