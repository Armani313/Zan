						...
						<div className="flex flex-wrap mb-24">
							<div className="relative w-full lg:w-1/2 h-128 mb-20 lg:mb-0 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
								...
								<Image
									...
									height="0"
									sizes="100vw"
									style={{ width: "auto", height: "auto" }} className="absolute top-0 right-0 h-full w-full rounded-xl object-cover object-top" src="/assets/imgs/placeholders/img-1.png" alt="Monst" />
							</div>
							<div className="w-full lg:w-1/2 lg:pl-24 my-auto">
								<Image
									...
									height="0"
									sizes="100vw"
									style={{ width: "auto", height: "auto" }} src="/assets/imgs/icons/quote.svg" alt="Monst" className="wow animate__animated animate__fadeIn" data-wow-delay=".2s" />
						...
						<div className="flex flex-wrap items-center justify-center max-w-4xl mx-auto pt-4 pb-4">
							<div className="w-1/2 md:w-1/3 lg:w-1/5 px-8 mb-8 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
								<Image
									...
									height="0"
									sizes="100vw"
									style={{ width: "auto", height: "auto" }} className="mx-auto" src="/assets/imgs/logos/brands/brand-1.png" alt="Monst" />
							</div>
							<div className="w-1/2 md:w-1/3 lg:w-1/5 px-8 mb-8 wow animate__animated animate__fadeIn" data-wow-delay=".3s">
								<Image
									...
									height="0"
									sizes="100vw"
									style={{ width: "auto", height: "auto" }} className="mx-auto" src="/assets/imgs/logos/brands/brand-2.png" alt="Monst" />
							</div>
							<div className="w-1/2 md:w-1/3 lg:w-1/5 px-8 mb-8 wow animate__animated animate__fadeIn" data-wow-delay=".5s">
								<Image
									...
									height="0"
									sizes="100vw"
									style={{ width: "auto", height: "auto" }} className="mx-auto" src="/assets/imgs/logos/brands/brand-3.png" alt="Monst" />
							</div>
							<div className="w-1/2 md:w-1/3 lg:w-1/5 px-8 mb-8 wow animate__animated animate__fadeIn" data-wow-delay=".7s">
								<Image
									...
									height="0"
									sizes="100vw"
									style={{ width: "auto", height: "auto" }} className="mx-auto" src="/assets/imgs/logos/brands/brand-4.png" alt="Monst" />
							</div>
							<div className="hidden md:block w-1/2 md:w-1/3 lg:w-1/5 px-8 mb-8 wow animate__animated animate__fadeIn" data-wow-delay=".9s">
								<Image
									...
									height="0"
									sizes="100vw"
									style={{ width: "auto", height: "auto" }} className="mx-auto" src="/assets/imgs/logos/brands/brand-5.png" alt="Monst" />
							</div>
						</div>
					</div>
				</section>
					...
					<div className="container">
						<div className="max-w-lg mx-auto mb-12 text-center">
							<Image
								...
								height="0"
								sizes="100vw"
								style={{ width: "auto", height: "auto" }} className="mx-auto" src="/assets/imgs/icons/quote.svg" alt="Monst" />
								...
								<div className="px-6 py-10 bg-white shadow rounded hover-up-5 wow animate__animated animate__fadeIn animated border border-gray-100 hover:border-gray-200" data-wow-delay=".7s">
									<div className="flex items-center mb-4">
										<Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} className="h-16 w-16 rounded-full object-cover" src="/assets/imgs/placeholders/avatar-5.png" alt="Monst" />
										<div className="pl-4">
											<strong className="mt-6 mb-2 text-md">Dany Connolly</strong>
											<p className="text-gray-500 text-xs mt-3">Direct-Founder</p>
										</div>
								...
								<div className="px-6 py-10 bg-white shadow rounded hover-up-5 wow animate__animated animate__fadeIn animated border border-gray-100 hover:border-gray-200" data-wow-delay=".7s">
									<div className="flex items-center mb-4">
										<Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} className="h-16 w-16 rounded-full object-cover" src="/assets/imgs/placeholders/avatar-6.png" alt="Monst" />
										<div className="pl-4">
											<strong className="mt-6 mb-2 text-md">Dany Connolly</strong>
											<p className="text-gray-500 text-xs mt-3">Direct-Founder</p>
										</div>
						...
						<div className="text-center pt-12">
							<Link className="hover-up-5 inline-block py-4 px-8 text-xs text-white font-semibold leading-none bg-blue-400 hover:bg-blue-500 rounded" href="#">Show more Testimonials</Link>
						</div>
					</div>
				</section>
