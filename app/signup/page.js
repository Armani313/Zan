							...
							<div className="mt-12 mb-8 p-8 bg-white rounded shadow">
								...
								<div className="w-full mt-12 mx-auto text-center">
									<p className="text-sm">
										...
										<Link href="/login" className="inline-block text-xs text-blue-600 hover:text-blue-700 font-semibold leading-none wow animate__animated animate__fadeIn animated" data-wow-delay=".1s">
											Sign in now
