				...
				<section className="pb-8 bg-top bg-cover bg-no-repeat relative -mt-24 pt-24" style={{ "backgroundImage": "url('/assets/imgs/backgrounds/intersect.svg')" }}>
					<div className="hidden md:block absolute top-0 left-0 mt-32">
						<Image
							...
							height="0"
							sizes="100vw"
							style={{ width: "auto", height: "auto" }} className="h-64 lg:h-80 jump" src="/assets/imgs/illustrations/at_the_park.svg" alt="Monst" />
					</div>
					<div className="hidden md:block absolute top-0 right-0 mt-32">
						<Image
							...
							height="0"
							sizes="100vw"
							style={{ width: "auto", height: "auto" }} className="h-64 lg:h-80 jump" src="/assets/imgs/illustrations/delivered.svg" alt="Monst" />
					</div>
							...
							<div className="max-w-2xl mx-auto text-center">
								<div className="flex flex-wrap">
									...
									<div className="w-full lg:w-auto">
										<Link className="block w-full py-4 px-6 mb-2 lg:w-auto text-xs text-white font-semibold leading-none bg-blue-500 hover:bg-blue-700 rounded" href="#">Register
										</Link>
									</div>
								</div>
							</div>
						...
						<div className="flex flex-wrap">
							...
							<div className="w-full md:w-1/2 px-3 order-0 md:order-1 mb-12 md:mb-0 wow animate__animated animate__fadeIn" data-wow-delay=".5s">
								<Image
									...
									height="0"
									sizes="100vw"
									style={{ width: "auto", height: "auto" }} className="sm:max-w-sm lg:max-w-full mx-auto" src="/assets/imgs/illustrations/podcast.svg" alt="Monst" />
							</div>
						</div>
					</div>
				</section>
						...
						<div className="flex flex-wrap lg:flex-nowrap">
							<div className="flex flex-wrap lg:max-w-sm mx-auto">
								<Image
									...
									height="0"
									sizes="100vw"
									style={{ width: "auto", height: "auto" }} className="jump sm:max-w-sm lg:max-w-full mx-auto wow animate__animated animate__fadeIn" data-wow-delay=".5s" src="/assets/imgs/illustrations/tasks.svg" alt="Monst" />
							</div>
							<div className="w-full lg:w-auto">
								...
								<div className="px-6 py-10 bg-white shadow rounded">
									<div className="flex items-center mb-4">
										<Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} className="h-16 w-16 rounded-full object-cover" src="/assets/imgs/placeholders/img-1.png" alt="Monst" />
										<div className="pl-4">
								...
								<div className="px-6 py-10 bg-white shadow rounded">
									<div className="flex items-center mb-4">
										<Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} className="h-16 w-16 rounded-full object-cover" src="/assets/imgs/placeholders/img-2.jpg" alt="Monst" />
										<div className="pl-4">
								...
								<div className="px-6 py-10 bg-white shadow rounded">
									<div className="flex items-center mb-4">
										<Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} className="h-16 w-16 rounded-full object-cover" src="/assets/imgs/placeholders/img-5.jpg" alt="Monst" />
										<div className="pl-4">
								...
								<div className="px-6 py-10 bg-white shadow rounded">
									<div className="flex items-center mb-4">
										<Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} className="h-16 w-16 rounded-full object-cover" src="/assets/imgs/placeholders/img-6.png" alt="Monst" />
										<div className="pl-4">
