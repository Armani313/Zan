						...
						<div className="flex flex-wrap -mx-3 mb-6 lg:mb-0">
							<div className="w-full lg:w-1/2 flex flex-wrap px-3 mb-6 lg:md-0">
								<div className="hover-up-5 w-1/2 h-64 pr-3 pb-3 wow animate__animated animate__fadeIn animated" data-wow-delay=".1s">
									<Image
										...
										height="0"
										sizes="100vw"
										style={{ width: "auto", height: "auto" }} className="h-full object-cover rounded" src="/assets/imgs/placeholders/img-10.jpg" alt="Monst" />
								</div>
								<div className="hover-up-5 w-1/2 h-64 pl-3 pb-3 wow animate__animated animate__fadeInanimated" data-wow-delay=".2s">
									<Image
										...
										height="0"
										sizes="100vw"
										style={{ width: "auto", height: "auto" }} className="h-full object-cover rounded" src="/assets/imgs/placeholders/img-11.jpg" alt="Monst" />
								</div>
								<div className="hover-up-5 w-1/2 h-64 pr-3 pt-3 wow animate__animated animate__fadeIn animated" data-wow-delay=".3s">
									<Image
										...
										height="0"
										sizes="100vw"
										style={{ width: "auto", height: "auto" }} className="h-full object-cover rounded" src="/assets/imgs/placeholders/img-12.jpg" alt="Monst" />
								</div>
								<div className="hover-up-5 w-1/2 h-64 pl-3 pt-3 wow animate__animated animate__fadeIn animated" data-wow-delay=".4s">
									<Image
										...
										height="0"
										sizes="100vw"
										style={{ width: "auto", height: "auto" }} className="h-full object-cover rounded" src="/assets/imgs/placeholders/img-13.jpg" alt="Monst" />
								</div>
							</div>
							<div className="hover-up-5 w-full lg:w-1/2 px-3 relative wow animate__animated animate__fadeIn animated" data-wow-delay=".6s">
								<Image
									...
									height="0"
									sizes="100vw"
									style={{ width: "auto", height: "auto" }} className="lg:h-128 w-full object-cover rounded" src="/assets/imgs/placeholders/img-9.jpg" alt="Monst" />
								<div className="absolute text-center bg-white rounded card-label-center px-4 py-12">
									...
									<Link href="/blog-single" className="tracking-wide hover-up-2 inline-block px-4 py-3 text-xs font-semibold leading-none bg-blue-400 hover:bg-blue-500 text-white rounded">View details
									</Link>
								</div>
							</div>
						</div>
						<div className="flex flex-wrap -mx-3 mb-6">
							<div className="hover-up-5 w-full lg:w-1/2 px-3 order-last lg:order-first mt-6 lg:mt-0 relative wow animate__animated animate__fadeIn animated" data-wow-delay=".1s">
								<Image
									...
									height="0"
									sizes="100vw"
									style={{ width: "auto", height: "auto" }} className="h-128 w-full object-cover rounded" src="/assets/imgs/placeholders/img-9.jpg" alt="Monst" />
								<div className="absolute text-center bg-white rounded card-label-center px-4 py-12">
									<div className="w-full flex place-content-center">
