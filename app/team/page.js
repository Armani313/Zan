					...
					<div className="container text-center">
						...
						<ul className="mx-auto text-gray-500 text-sm lg:text-sm pb-12 wow animate__animated animate__fadeIn animated">
							<li className="inline-flex items-center">
								<Link href="#" className="hover:text-blue-500 text-gray-800">Home
								</Link>
								...
								<div className="px-6 py-10 bg-white shadow rounded hover-up-5 wow animate__animated animate__fadeIn animated border border-gray-100 hover:border-gray-200" data-wow-delay=".1s">
									<div className="flex items-center mb-4">
										<Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} className="h-16 w-16 rounded-full object-cover" src="/assets/imgs/placeholders/avatar-1.png" alt="Monst" />
										<div className="pl-4">
								...
								<div className="px-6 py-10 bg-white shadow rounded hover-up-5 wow animate__animated animate__fadeIn animated border border-gray-100 hover:border-gray-200" data-wow-delay=".3s">
									<div className="flex items-center mb-4">
										<Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} className="h-16 w-16 rounded-full object-cover" src="/assets/imgs/placeholders/avatar-2.png" alt="Monst" />
										<div className="pl-4">
								...
								<div className="px-6 py-10 bg-white shadow rounded hover-up-5 wow animate__animated animate__fadeIn animated border border-gray-100 hover:border-gray-200" data-wow-delay=".5s">
									<div className="flex items-center mb-4">
										<Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} className="h-16 w-16 rounded-full object-cover" src="/assets/imgs/placeholders/avatar-3.png" alt="Monst" />
										<div className="pl-4">
								...
								<div className="px-6 py-10 bg-white shadow rounded hover-up-5 wow animate__animated animate__fadeIn animated border border-gray-100 hover:border-gray-200" data-wow-delay=".7s">
									<div className="flex items-center mb-4">
										<Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} className="h-16 w-16 rounded-full object-cover" src="/assets/imgs/placeholders/avatar-4.png" alt="Monst" />
										<div className="pl-4">
						...
						<div className="flex flex-wrap -mx-3">
							<div className="w-full md:w-1/2 lg:w-1/4 px-3 mb-12 hover-up-5 wow animate__animated animate__fadeIn animated" data-wow-delay=".4s">
								<Image
									...
									height="0"
									sizes="100vw"
									style={{ width: "auto", height: "auto" }} className="h-64 w-64 mx-auto rounded object-cover object-top" src="/assets/imgs/placeholders/avatar-1.png" alt="Monst" />
								...
								<div className="flex py-1 justify-center space-x-2">
									<Image
										...
										height="0"
										sizes="100vw"
										style={{ width: "auto", height: "auto" }} src="/assets/imgs/icons/facebook.svg" alt="Monst" />
									<Image
										width="0"
										height="0"
										sizes="100vw"
										style={{ width: "auto", height: "auto" }} src="/assets/imgs/icons/twitter.svg" alt="Monst" />
								</div>
							</div>
							...
							<div className="w-full md:w-1/2 lg:w-1/4 px-3 mb-12 hover-up-5 wow animate__animated animate__fadeIn animated" data-wow-delay=".3s">
								<Image
									...
									height="0"
									sizes="100vw"
									style={{ width: "auto", height: "auto" }} className="h-64 w-64 mx-auto rounded object-cover object-top" src="/assets/imgs/placeholders/avatar-2.png" alt="Monst" />
							...
							<div className="w-full md:w-1/2 lg:w-1/4 px-3 mb-12 hover-up-5 wow animate__animated animate__fadeIn animated" data-wow-delay=".5s">
								<Image
									...
									height="0"
									sizes="100vw"
									style={{ width: "auto", height: "auto" }} className="h-64 w-64 mx-auto rounded object-cover object-top" src="/assets/imgs/placeholders/avatar-3.png" alt="Monst" />
							...
							<div className="w-full md:w-1/2 lg:w-1/4 px-3 mb-12 hover-up-5 wow animate__animated animate__fadeIn animated" data-wow-delay=".7s">
								<Image
									...
									height="0"
									sizes="100vw"
									style={{ width: "auto", height: "auto" }} className="h-64 w-64 mx-auto rounded object-cover object-top" src="/assets/imgs/placeholders/avatar-4.png" alt="Monst" />
							...
							<div className="w-full md:w-1/2 lg:w-1/4 px-3 mb-12 hover-up-5 wow animate__animated animate__fadeIn animated" data-wow-delay=".1s">
								<Image
									...
									height="0"
									sizes="100vw"
									style={{ width: "auto", height: "auto" }} className="h-64 w-64 mx-auto rounded object-cover object-top" src="/assets/imgs/placeholders/avatar-5.png" alt="Monst" />
							...
							<div className="w-full md:w-1/2 lg:w-1/4 px-3 mb-12 hover-up-5 wow animate__animated animate__fadeIn animated" data-wow-delay=".3s">
								<Image
									...
									height="0"
									sizes="100vw"
									style={{ width: "auto", height: "auto" }} className="h-64 w-64 mx-auto rounded object-cover object-top" src="/assets/imgs/placeholders/avatar-6.png" alt="Monst" />
							...
							<div className="w-full md:w-1/2 lg:w-1/4 px-3 mb-12 hover-up-5 wow animate__animated animate__fadeIn animated" data-wow-delay=".5s">
								<Image
									...
									height="0"
									sizes="100vw"
									style={{ width: "auto", height: "auto" }} className="h-64 w-64 mx-auto rounded object-cover object-top" src="/assets/imgs/placeholders/avatar-7.png" alt="Monst" />
							...
							<div className="w-full md:w-1/2 lg:w-1/4 px-3 mb-12 hover-up-5 wow animate__animated animate__fadeIn animated" data-wow-delay=".7s">
								<Image
									...
									height="0"
									sizes="100vw"
									style={{ width: "auto", height: "auto" }} className="h-64 w-64 mx-auto rounded object-cover object-top" src="/assets/imgs/placeholders/avatar-8.png" alt="Monst" />
