						...
						<div className="flex flex-wrap items-center -mx-3">
							<div className="w-full lg:w-2/5 px-3">
								...
								<div className="text-center lg:text-left">
									<Link className="tracking-wide hover-up-2 block sm:inline-block py-4 px-8 mb-4 sm:mb-0 sm:mr-3 text-xs text-white text-center font-semibold leading-none bg-blue-500 hover:bg-blue-700 rounded wow animate__animated animate__fadeIn" href="#key-features">
										Key Features
									</Link>
									<Link className="block sm:inline-block hover-up-2 py-4 px-8 text-xs text-blueGray-500 hover:text-blueGray-600 text-center font-semibold leading-none bg-white border border-blueGray-200 hover:border-blueGray-300 rounded wow animate__animated animate__fadeIn" data-wow-delay=".3s" href="#how-we-work">
										How We Work?
									</Link>
								</div>
							</div>
							<div className="w-full lg:w-3/5 px-3 mb-12 lg:mb-0">
								<div className="lg:h-128 flex items-center justify-center">
									<Image
										...
										height="0"
										sizes="100vw"
										style={{ width: "auto", height: "auto" }} className="lg:max-w-lg" src="/assets/imgs/illustrations/work-tv.png" alt="Monst" />
								</div>
							</div>
						</div>
					</div>
					...
					<div className="container">
						...
						<div className="relative max-w-6xl mx-auto wow animate__animated animate__fadeIn" data-wow-delay=".3s">
							<Image
								...
								height="0"
								sizes="100vw"
								style={{ width: "auto", height: "auto" }} src="/assets/imgs/elements/macbook.png" alt="Monst" />
					...
					<div className="container">
						...
						<div className="text-center">
							<Link href="/testimonials" legacyBehavior>
								<Link href="/testimonials" className="inline-block py-4 px-8 text-xs text-white font-semibold leading-none bg-blue-500 hover:bg-blue-700 rounded wow animate__animated animate__fadeIn" data-wow-delay=".3s">
						...
						<div className="flex flex-wrap -mx-3">
							<div className="w-full md:w-1/2 lg:w-1/3 px-3 mb-6">
								<div className="hover-up-5 pt-16 pb-8 px-4 text-center bg-white rounded shadow wow animate__animated animate__fadeIn" data-wow-delay=".2s">
									...
									<div>
										<Link className="block sm:inline-block py-4 px-6 mb-4 sm:mb-0 sm:mr-3 text-xs text-white text-center font-semibold leading-none bg-blue-500 hover:bg-blue-700 rounded" href="#">
											Start Free Trial
										</Link>
