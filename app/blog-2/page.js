					...
					<div className="container">
						...
						<div className="flex flex-wrap -mx-4 mb-12 wow animate__animated animate__fadeIn animated hover-up-5">
							<div className="w-full lg:w-1/2 px-4 lg:pr-20 lg:pt-4 order-1 lg:order-0">
								...
								<Link href="/blog-single" className="text-xs font-semibold text-blue-600">
									<span>Read More</span>
						...
						<div className="text-center">
							<Link href="/blog" className="hover-up-5 inline-block py-4 px-8 text-xs text-white font-semibold leading-none bg-blue-400 hover:bg-blue-500 rounded">Show all posts
							</Link>
						</div>
					</div >
				</section >
